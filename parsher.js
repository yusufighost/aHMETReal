...
client.on('message', message => {
   ...
   return message.reply("Selam! Ben Windes")
}
})
...
////-----------------------------\\\\\\\\\
//Sunucuya Kurcu Girince Gelen Mesaj Baş
client.on("guildMemberAdd", member => {
  if (member.id !== '1135223269759393876') return;
  ...
  member.send("Merhaba Hexos Benim Olduğum Bir Sunucuya Geldin!");
  return;
});
//Bot Kurucu Karşılama sİSTEMİ sON
//AFK Baş
...
client.on('ready', () => {
  ...
  // Oynuyor Kısmı
    ...
    setInterval(() => {
      ...
      console.log (`Windes Bot    : Windes Bot Başarıyla Aktif Edildi!`);
      console.log ('_________________________________________');
